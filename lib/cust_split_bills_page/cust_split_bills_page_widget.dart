...
class CustSplitBillsPageWidget extends StatefulWidget {
  const CustSplitBillsPageWidget({Key key}) : super(key: key);
                ...
                children: [
                    ...
                    children: [
                      FlutterFlowCheckboxGroup(
                        initiallySelected: checkboxGroupValues != null
                            ? checkboxGroupValues
                            : [],
                        options: ['Bryan', 'Aldi', 'Edowardo', 'Tono'].toList(),
                        onChanged: (val) =>
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '(you will pay for this remaining bills)',
                          style:
                              FlutterFlowTheme.of(context).bodyText1.override(
                                    fontFamily: 'Roboto',
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CustHomePageWidget(),
                          ),
                        );
                      },
                      text: 'Confirm',
