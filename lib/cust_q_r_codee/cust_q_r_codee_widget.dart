...
class CustQRCodeeWidget extends StatefulWidget {
  const CustQRCodeeWidget({Key key}) : super(key: key);

  @override
  _CustQRCodeeWidgetState createState() => _CustQRCodeeWidgetState();
}

class _CustQRCodeeWidgetState extends State<CustQRCodeeWidget> {
