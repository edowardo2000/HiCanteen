...
class CustSignupPageWidget extends StatefulWidget {
  const CustSignupPageWidget({Key key}) : super(key: key);

  @override
  _CustSignupPageWidgetState createState() => _CustSignupPageWidgetState();
}

class _CustSignupPageWidgetState extends State<CustSignupPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CustomerRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CustomerRecord> custSignupPageCustomerRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final custSignupPageCustomerRecord =
            custSignupPageCustomerRecordList.isNotEmpty
                ? custSignupPageCustomerRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
