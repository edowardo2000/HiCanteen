...
class CustEmailSigninPageWidget extends StatefulWidget {
  const CustEmailSigninPageWidget({Key key}) : super(key: key);

  @override
  _CustEmailSigninPageWidgetState createState() =>
      _CustEmailSigninPageWidgetState();
}

class _CustEmailSigninPageWidgetState extends State<CustEmailSigninPageWidget> {
