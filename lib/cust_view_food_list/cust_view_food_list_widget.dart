      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: StreamBuilder<List<CanteenRecord>>(
              stream: queryCanteenRecord(
                queryBuilder: (canteenRecord) => canteenRecord.where('uid',
                    isEqualTo: custViewFoodListCanteenRecord.uid),
                singleRecord: true,
              ),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                ...
                List<CanteenRecord> textCanteenRecordList = snapshot.data;
                // Return an empty Container when the document does not exist.
                if (snapshot.data.isEmpty) {
                  return Container();
                }
                final textCanteenRecord = textCanteenRecordList.isNotEmpty
                    ? textCanteenRecordList.first
                    : null;
                return Text(
                  custViewFoodListCanteenRecord.cantName,
