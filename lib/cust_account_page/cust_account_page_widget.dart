  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRecord> custAccountPageUserRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final custAccountPageUserRecord =
            custAccountPageUserRecordList.isNotEmpty
                ? custAccountPageUserRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                ...
                children: [
                  Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: FutureBuilder<List<CustomerRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CustomerRecord> columnCustomerRecordList =
                                  snapshot.data;
                              // Return an empty Container when the document does not exist.
                              if (snapshot.data.isEmpty) {
                                return Container();
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0, 10, 0, 0),
                                    child: Text(
                                      'RM ${columnCustomerRecord.customerBalance}',
                                      style: FlutterFlowTheme.of(context)
                                          .title1
                                          .override(
                                            fontFamily: 'Roboto',
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(228, 5, 55, 0),
                        child: InkWell(
                          onTap: () async {
                            await Navigator.push(
                              context,
